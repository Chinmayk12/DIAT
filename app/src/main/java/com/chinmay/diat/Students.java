...
public class Students extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.home) {
                ...
                startActivity(new Intent(Students.this, AllAchievements.class));
                drawerLayout.closeDrawer(GravityCompat.START);
                return true;
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fileUri == null || filename.isEmpty()) {
                    Toast.makeText(Students.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void uploadFileToFirebase(Uri fileUri, String filename) {
        if (fileUri != null) {
            StorageReference fileRef = storageReference.child("students/" + filename);
            fileRef.putFile(fileUri)
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    Toast.makeText(Students.this, "File uploaded to storage", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    })
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(Students.this, "Failed to upload file: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
        }
    }
        ...
        db.collection("documents")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(Students.this, "File link saved to Firestore", Toast.LENGTH_SHORT).show();
                        String documentId = documentReference.getId();
                        // Optionally update the document to include the documentId
                        documentReference.update("documentId", documentId);
                        documentReference.update("departmentId", "students");
                        fetchDocumentsFromFirestore();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Students.this, "Failed to save file link: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
