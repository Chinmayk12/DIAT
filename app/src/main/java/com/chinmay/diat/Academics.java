...
public class Academics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.home) {
                ...
                startActivity(new Intent(Academics.this, AllAchievements.class));
                drawerLayout.closeDrawer(GravityCompat.START);
                return true;
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (fileUri == null || filename.isEmpty()) {
                    Toast.makeText(Academics.this, "Please Enter All Fields", Toast.LENGTH_SHORT).show();
                } else {
                    // Proceed with uploading the file and saving the data
                    // Initialize ProgressDialog
                    progressDialog = new ProgressDialog(Academics.this);
    ...
    private void uploadFileToFirebase(Uri fileUri, String filename) {
        if (fileUri != null) {
            StorageReference fileRef = storageReference.child("academics/" + filename);
        ...
        db.collection("documents")
                ...
                .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    ...
                    public void onSuccess(DocumentReference documentReference) {
                        Toast.makeText(Academics.this, "File link saved to Firestore", Toast.LENGTH_SHORT).show();
                        String documentId = documentReference.getId();
                        // Optionally update the document to include the documentId
                        documentReference.update("documentId", documentId);
                        documentReference.update("departmentId", "academics");
                        fetchDocumentsFromFirestore();
                    }
                })
                .addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(Academics.this, "Failed to save file link: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
    }
